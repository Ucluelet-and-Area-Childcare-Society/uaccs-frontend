...
const items = [
  {
    ...
    title: "Safe & Licensed",
    subtext:
      "Assisted living act child care licensed facilities with full safety protocols",
  ...
  return (
    <>
      <div className="relative overflow-hidden w-full">
        <Background />
        <div className="relative flex flex-col items-center p-10 mx-auto z-10 max-w-7xl">
            ...
            <div className="flex flex-col gap-6">
              ...
              <div className="flex gap-15 mt-10">
                {[
                  ...
                  <div key={stat.label}>
                    <div className="font-nunito text-3xl font-extrabold text-[#5BA4B5]">
                      {stat.value}
                    </div>
            ...
            <div className="flex flex-row items-center gap-15">
              <div className="flex flex-col gap-10 w-1/2">
                ...
                <h3 className="font-nunito font-bold text-2xl text-[#264D57]">
                  Affordable, Inclusive, Safe, and Nurturing childcare for every
                  family
                </h3>
                <p className="text-justify leading-relaxed">
                  At UACCS, we believe every child deserves a nurturing,
                  high-quality early education — regardless of family income.
                  Our $10/day BC Affordable Child Care Benefit rate means you
                  never have to choose between work and your child's wellbeing.
                </p>
                <p className="text-justify leading-relaxed">
                  It is our privilege and honour to play a part in shaping a
                  brighter future for the next generation of Ucluelet residents.
                </p>
                <NavLink
                  to="/about/who-we-are"
                  className="flex flex-row gap-1 bg-uaccs_blue px-6 py-4 rounded-full text-white font-nunito duration-200 transition-all hover:shadow-xl hover:translate-x-1 hover:-translate-y-1 w-fit"
                >
                  Learn More
                  <ArrowRight />
                </NavLink>
